    ...
    <div className="min-h-screen overflow-x-hidden bg-white">
      <header className="sticky top-0 z-[60] border-b border-line bg-white/[.88] backdrop-blur-[16px]">
        <div className="mx-auto flex max-w-[1220px] flex-wrap items-center gap-4 px-[22px] py-[13px]">
          <button
            onClick={() => navigate('/')}
            className="flex cursor-pointer items-center gap-[10px] border-none bg-transparent p-0"
          >
            <span className="block h-[26px] w-[26px] rounded-[9px] bg-acc" />
            <span className="font-display text-[19px] font-extrabold tracking-[-.02em] text-ink">
              Radix Connect
            </span>
          </button>
